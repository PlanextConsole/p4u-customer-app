...
/// Firebase options for the customer Android app (`com.p4u_customer`).
///
...
class DefaultFirebaseOptions {
  static FirebaseOptions get currentPlatform {
    if (kIsWeb) {
      throw UnsupportedError('Customer mobile app does not target web.');
    }
  ...
  static const FirebaseOptions android = FirebaseOptions(
    ...
    appId: '1:784503032650:android:9f04cccd93da071b028fb3',
